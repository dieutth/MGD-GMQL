...
object SelectIRD {
  ...
  var executor: MGD_GMQLSparkExecutor = null

  @throws[SelectFormatException]
  def apply(executor: MGD_GMQLSparkExecutor, regionCondition: Option[RegionCondition], filteredMeta: Option[MetaOperator], loader: GMQLLoader[Any, Any, Any, Any], URIs: List[String], repo: Option[String], sc: SparkContext): RDD[GRECORD] = {
