...
object ArrArrJoin_Multimatrix {
  ...
  def apply(ref: RDD[((Int, Long, Long, Short), (Array[Array[Long]],Array[Array[Array[Double]]]))],
            ...
            greater: Option[DistGreater]): RDD[((Int, Long, Long, Short), (Array[Array[Long]], Array[Array[Array[Double]]]))] = {
  ...
  private def execute(ref: RDD[((Int,Long),(Long,Long,Short,Array[Array[Long]],Array[Array[Array[Double]]]))],
                      ...
                      joinType: RegionBuilder,
                      less: DistLess,
                      greater: DistGreater): RDD[((Int, Long, Long, Short), (Array[Array[Long]], Array[Array[Array[Double]]]))] = {
