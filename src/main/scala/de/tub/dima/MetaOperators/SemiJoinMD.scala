...
object SemiJoinMD {
  ...
  def apply(executor : MGD_GMQLSparkExecutor, externalMeta : MetaOperator, joinCondition : MetaJoinCondition, inputDataset : MetaOperator, sc : SparkContext) : RDD[MetaType] = {
