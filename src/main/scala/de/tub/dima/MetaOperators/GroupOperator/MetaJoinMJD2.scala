package de.tub.dima.MetaOperators.GroupOperator
...
object MetaJoinMJD2 {
  ...
  def apply(executor: MGD_GMQLSparkExecutor, condition: MetaJoinCondition, leftDataset: MetaOperator, rightDataset: MetaOperator, empty: Boolean, sc: SparkContext): RDD[SparkMetaJoinType] = {
