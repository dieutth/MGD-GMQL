package de.tub.dima.MetaOperators
...
object GroupMD {
  ...
  def apply(executor: MGD_GMQLSparkExecutor, groupingKeys : MetaGroupByCondition, aggregates : Option[List[MetaAggregateFunction]], newGroupNameInMeta : String, inputDataset : MetaOperator, regionDataset : RegionOperator, sc: SparkContext): RDD[MetaType] = {
    ...
    import de.tub.dima.MetaOperators.GroupOperator.MetaGroupMGD._
